...
function Temple(config) {
    ...
    this.version = "2.1.0", this.color = "#ff0088", this.isMobile = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent),
    ...
    this.isBackup = document.body.classList.contains("phantom-backup"), this.core = {},
    this.config = config, this.platforms = {}, this.templates = {}, this.modules = {};
    ...
    this.create = function() {
        if (temple.utils.getQueryVar("backup") == "true") this.isBackup = true;
...
temple.MVRBanner = function(_super) {
    ...
    MVRBanner.prototype.initDynamicComponents = function() {
        ...
        switch (this.skin) {
          case "light":
            TweenMax.set([ $("#banner"), $("#innerPanel"), $("#tuneIn"), $("#disclaimer"), $("#panelShadow"), $("#n_ribbon") ], {
                className: "+=lightSkin"
            });
            break;
...
temple.Banner = function(_super) {
    ...
    banner.prototype.initDynamicComponents = function(done) {
        ...
        switch (this.contentType) {
          case "original":
            ...
            TweenMax.set([ $("#cta"), $("#logo"), $(".ratingbug"), $("#disclaimer"), $("#tuneIn") ], {
                className: "+=original"
            });
            break;
    ...
    banner.prototype.setupTimeline = function() {
        ...
        this.carouselTimeline.to($("#title1"), 1.2, {
            x: -340,
            ease: Power2.easeOut
        }, "carousel1").to($("#ratingbug1"), .5, {
            opacity: 0,
            ease: Power2.easeOut
        }, "carousel1").from($("#title2"), 1, {
            x: 150,
            ease: Power2.easeOut
        }, "carousel1").from($("#ratingbug2"), .5, {
            opacity: 0,
            ease: Power2.easeOut
        }, "carousel1").add("carousel2", "+=1").to($("#title2"), 1.2, {
            x: -340,
            ease: Power2.easeOut
        }, "carousel2").to($("#ratingbug2"), .5, {
            opacity: 0,
            ease: Power2.easeOut
        }, "carousel2");
        if (this.nrOfTitles == 2) {
            this.carouselTimeline.set($("#title3"), {
                opacity: 0
            }, "carousel2").set($("#title1"), {
                css: {
                    zIndex: -1
                }
            }, "carousel2").set($("#title1"), {
                x: 150
            }, "carousel2").to($("#title1"), 1, {
                x: 0,
                ease: Power2.easeOut
            }, "carousel2").to($("#ratingbug1"), .5, {
                opacity: 1,
                ease: Power2.easeOut
            }, "carousel2");
        }
        if (this.nrOfTitles == 3) {
            this.carouselTimeline.from($("#title3"), 1, {
                x: 150,
                ease: Power2.easeOut
            }, "carousel2").from($("#ratingbug3"), .5, {
                opacity: 0,
                ease: Power2.easeOut
            }, "carousel2").add("carousel3", "+=1").to($("#title3"), 1.2, {
                x: -340,
                ease: Power2.easeOut
            }, "carousel3").to($("#ratingbug3"), .5, {
                opacity: 0,
                ease: Power2.easeOut
            }, "carousel3").set($("#title1"), {
                css: {
                    zIndex: -1
                }
            }, "carousel3").set($("#title1"), {
                x: 150
            }, "carousel3").set($("#ratingbug1"), {
                opacity: 0
            }, "carousel3").to($("#title1"), 1, {
                x: 0,
                ease: Power2.easeOut
            }, "carousel3").to($("#ratingbug1"), .5, {
                opacity: 1,
                ease: Power2.easeOut
            }, "carousel3");
        }
        ...
        this.mainTimeline.add("start").set([ $("#titles"), $("#panel") ], {
            opacity: 1
        }, "start").from($("#titles"), 1, {
            y: -100,
            ease: Expo.easeOut
        }, "start").from($("#disclaimer"), 1, {
            opacity: 0,
            ease: Expo.easeOut
        }, "start").from($("#ratingbug1"), 1, {
            opacity: 0,
            ease: Expo.easeOut
        }, "start").from($("#panel"), 1, {
            y: -200,
            ease: Expo.easeOut
        }, "start").addCallback($("#logo").play.bind($("#logo")), "start+=.3").from($("#cta"), 1, {
            css: {
                width: 0
            },
            ease: Quad.easeOut
        }, "start+=1.2").add("endframe");
        ...
        var component = Object.create(HTMLElement.prototype, {
            attachedCallback: {
                value: function() {
                    ...
                    this.timeline.add("start").to(this.n_leftShape, 1.3, {
                        morphSVG: this.n_leftShape.to,
                        ease: Quad.easeOut
                    }, "start+=.2").to(this.n_leftShape.gradient, 1.3, {
                        stopColor: this.color,
                        ease: Linear.easeNone
                    }, "start+=.2").to(this.n_rightShape, 1.3, {
                        morphSVG: this.n_rightShape.to,
                        ease: Quad.easeOut
                    }, "start+=.2").to(this.n_rightShape.gradient, 1.3, {
                        stopColor: this.color,
                        ease: Linear.easeNone
                    }, "start+=.2").to(this.n_midShape, 1.3, {
                        morphSVG: this.n_midShape.to,
                        ease: Quad.easeOut
                    }, "start+=.2").fromTo(this.e_topShape, .15, {
                        morphSVG: this.e_topShape.to
                    }, {
                        morphSVG: this.e_topShape,
                        ease: Quad.easeOut
                    }, "start+=.425").fromTo(this.e_mainShape, .15, {
                        morphSVG: this.e_mainShape.to
                    }, {
                        morphSVG: this.e_mainShape,
                        ease: Quad.easeOut
                    }, "start+=.45").to(this.e_mainShape.gradient, .3, {
                        stopColor: this.color,
                        ease: Linear.easeNone
                    }, "start+=.6").fromTo(this.e_midShape, .15, {
                        morphSVG: this.e_midShape.to
                    }, {
                        morphSVG: this.e_midShape,
                        ease: Quad.easeOut
                    }, "start+=.55").fromTo(this.e_bottomShape, .15, {
                        morphSVG: this.e_bottomShape.to
                    }, {
                        morphSVG: this.e_bottomShape.to,
                        ease: Quad.easeOut
                    }, "start+=.575").to(this.e_bottomShape, .15, {
                        morphSVG: "M 274 187 L 167 194 167 233 274 226 274 187 Z",
                        ease: Quad.easeOut
                    }, "start+=.585").to(this.e_bottomShape.gradient, .3, {
                        stopColor: this.color,
                        ease: Linear.easeNone
                    }, "start+=.595").fromTo(this.t_topShape, .15, {
                        morphSVG: this.t_topShape.to
                    }, {
                        morphSVG: this.t_topShape,
                        ease: Quad.easeOut
                    }, "start+=.575").fromTo(this.t_midShape, .15, {
                        morphSVG: this.t_midShape.to
                    }, {
                        morphSVG: this.t_midShape,
                        ease: Quad.easeOut
                    }, "start+=.6").to(this.t_midShape.gradient, .3, {
                        stopColor: this.color,
                        ease: Linear.easeNone
                    }, "start+=.75").fromTo(this.f_topShape, .15, {
                        morphSVG: this.f_topShape.to
                    }, {
                        morphSVG: this.f_topShape,
                        ease: Quad.easeOut
                    }, "start+=.625").fromTo(this.f_mainShape, .2, {
                        morphSVG: this.f_mainShape.to
                    }, {
                        morphSVG: this.f_mainShape,
                        ease: Quad.easeOut
                    }, "start+=.675").fromTo(this.f_midShape, .15, {
                        morphSVG: this.f_midShape.to
                    }, {
                        morphSVG: this.f_midShape,
                        ease: Quad.easeOut
                    }, "start+=.775").to(this.f_mainShape.gradient, .3, {
                        stopColor: this.color,
                        ease: Linear.easeNone
                    }, "start+=.9").fromTo(this.l_mainShape, .15, {
                        morphSVG: this.l_mainShape.to
                    }, {
                        morphSVG: this.l_mainShape,
                        ease: Quad.easeOut
                    }, "start+=.725").fromTo(this.l_bottomShape, .15, {
                        morphSVG: this.l_bottomShape.to
                    }, {
                        morphSVG: this.l_bottomShape,
                        ease: Quad.easeOut
                    }, "start+=.85").to(this.l_bottomShape, .3, {
                        morphSVG: "M 691 228 L 691 189 584 184 584 223 691 228 Z",
                        ease: Quad.easeOut
                    }, "start+=1").to(this.l_mainShape.gradient, .3, {
                        stopColor: this.color,
                        ease: Linear.easeNone
                    }, "start+=1.025").fromTo(this.i_mainShape, .15, {
                        morphSVG: this.i_mainShape.to
                    }, {
                        morphSVG: this.i_mainShape,
                        ease: Quad.easeOut
                    }, "start+=.875").fromTo(this.x_backShape, .3, {
                        morphSVG: this.x_backShape.to
                    }, {
                        morphSVG: this.x_backShape,
                        ease: Quad.easeOut
                    }, "start+=.925").to(this.x_frontShape, .3, {
                        morphSVG: {
                            shape: "M 935 1 L 893 1 790 237 831 241 935 1 Z",
                            shapeIndex: 3
                        },
                        ease: Quad.easeOut
                    }, "start+=1.025").to(this.x_backShape.gradient, .3, {
                        stopColor: this.color,
                        ease: Linear.easeNone
                    }, "start+=1.025");
        ...
        attachedCallback: {
            value: function() {
                ...
                this.timeline.fromTo(this.leftContainer, .2, {
                    ...
                    y: 0,
                    ease: Power2.easeIn,
                    onComplete: this.onCoverComplete.bind(this)
        ...
        resize: {
            value: function(w, h) {
                ...
                if (this.hasArrow) {
                    ...
                    pr = s * 16 + "%";
                    if (this.rtl) {
                        this.copy.setAttribute("style", "padding-top: " + (lines > 1 ? "0" : "20%") + "; padding-left: " + pr + ";padding-right: " + s * 16 + "%");
                    } else {
                        this.copy.setAttribute("style", "padding-top:" + (lines > 1 ? "0" : "20%") + "; padding-right: " + pr + ";padding-left: " + s * 16 + "%");
                    }
